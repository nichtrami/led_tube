 ...
 *
 * This function converts a color from HSV (Hue, Saturation, Value) color space 
 * to RGB (Red, Green, Blue) color space using the rainbow method. The rainbow 
 * method produces a more vivid and colorful result, especially for LED lighting.
 *
 * @param hue - The hue of the color in HSV color space. Range: 0 to 255.
 * @param sat - The saturation of the color in HSV color space. Range: 0 to 255.
 * @param val - The value (brightness) of the color in HSV color space. Range: 0 to 255.
 */
void LedController::hsv2rgb_rainbow( uint8_t hue, uint8_t sat, uint8_t val, uint8_t &red, uint8_t &green, uint8_t &blue)
{
